			      ...
			      bool    flag_host)
{
  ...
  if (flag_host)
    ...
    sigmoid_activation_onDev(z.data_device.get(), a.data_device.get(), z.size());
  return a;
}
			       ...
			       bool    flag_host)
{
  ...
  if (flag_host)
    ...
    sigmoid_activation_backprop_onDev(da.data_device.get(), z.data_device.get(), dz.data_device.get(), z.size());
  return dz;
}
