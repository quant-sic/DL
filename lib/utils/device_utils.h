...
__global__ void apply_pointwise_kernel(const real_type *dev_in, real_type *dev_out, int size, pointwise_func<real_type> func)
{
...
template <class real_type>
void apply_pointwise_onDev(const real_type *dev_in, real_type *dev_out, int size, pointwise_func<real_type> dev_func)
{
...
template <class real_type>
__global__ void hadamard_func_rhs_kernel(const real_type *dev_lhs, real_type *dev_rhs, real_type *dev_res, int size, pointwise_func<real_type> dev_func)
{
